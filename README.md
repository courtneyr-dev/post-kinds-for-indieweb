...
- **Publishes to the wider web** — through the required [ATmosphere](https://wordpress.org/plugins/atmosphere/) plugin, your posts publish as standard.site documents with kind-aware titles, tags, and privacy rules ([integration contract](docs/integrations/atmosphere-standard-site.md))
