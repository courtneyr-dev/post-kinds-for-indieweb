...
- **ATmosphere** — optional companion; owns the AT Protocol connection and publishes posts as [Standard.site records](/post-kinds-for-indieweb/standard-site/) with Bluesky cross-posting under its own settings. Post Kinds feeds it kind eligibility, derived titles, and kind tags.
