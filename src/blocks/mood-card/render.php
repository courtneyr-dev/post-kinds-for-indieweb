...
<article <?php echo $pkiw_wrapper_attrs; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
	...
	<div class="pk-body">
		...
		<div class="pk-mood">
			<?php if ( $pkiw_emoji ) : ?>
				<span class="pk-mood__emoji" role="img" aria-label="<?php echo esc_attr( $pkiw_mood ? $pkiw_mood : __( 'Mood', 'post-kinds-for-indieweb-in-block-themes' ) ); ?>"><?php echo esc_html( $pkiw_emoji ); ?></span>
			<?php endif; ?>
			<?php if ( $pkiw_note ) : ?>
