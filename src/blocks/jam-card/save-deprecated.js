/**
 * Jam Card Block - Deprecated Save Component
 *
 * This is the original save function preserved for block deprecation migration.
 * New posts use render.php for frontend output with save() returning null.
 *
 * @package
 */
				...
				<div className="post-kinds-card__content">
					...
					{ parseDate( jammedAt ) && (
						<time
							...
							dateTime={ parseDate( jammedAt ).toISOString() }
						>
							{ parseDate( jammedAt ).toLocaleString() }
						</time>
					) }
				</div>
			</div>
