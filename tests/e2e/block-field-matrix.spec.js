...
const RENDER_EXCEPTIONS = {
	...
	'post-kinds-indieweb/watch-card': {
		mediaType:
			'display-mode string driving the movie/tv/episode layout; the pk-card redesign shows a single Watch kind label and no longer echoes it as a badge modifier class',
		captionsUrl:
			'WebVTT file passed to the card video-embed filter; with no accessible-player filter active in tests the oEmbed fallback runs and the caption file is not echoed',
		showTitle:
