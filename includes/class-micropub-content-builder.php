...
final class Micropub_Content_Builder {
	 ...
	 *
	 * Public so other components (e.g. Book_Completion_Controller) can tell
	 * whether a save was Micropub-originated and apply the
	 * `pkiw_micropub_book_completion` opt-out gate.
	 *
	 * @var string
	 */
	public const GENERATED_META_KEY = '_pkiw_block_content_generated';
	...
	public static function apply( $input, $args ): void {
		...
		// check above. This same save_post also fires Book_Completion_Controller
		// (registered at priority 30), which fills blank read-card meta via
		// the injectable completion service — see
		// Book_Completion_Controller::complete_on_save() for the
		// `pkiw_micropub_book_completion` opt-out gate applied when this post
		// was generated by this Micropub bridge.
